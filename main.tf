...
module "docdb" {
  ...
  instant_count = each.value["instance_count"]
...
module "elasticache" {
  source = "git::https://github.com/sunil824922/tf-module-elasticache.git"
...
module "alb" {
  ...
  for_each   = var.alb
  subnets = lookup(lookup(lookup(lookup(module.vpc, "main", null), "subnets", null), each.value["subnet_name"] , null), "subnet_ids", null)
  allow_alb_cidr = each.value.["name"] "public" ? [ "0.0.0.0/0"] : lookup(lookup(lookup(lookup(module.vpc, "main", null), "subnets", null), each.value["allow_alb _cidr"], null), "subnet_cidrs", null)
